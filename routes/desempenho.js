module.exports = function(app){
	...
	//app.get('/home/desempenho/faltas/:id', autenticar, desempenho.faltas);
	...
	app.get('/home/desempenho/faltas/:id/registrar/:id_ava', autenticar, desempenho.registrarFaltas);
