   ...
   for (var i = 0; i < elements.length; i++) {
      elements[i].oninvalid = function (e) {
         ...
         if (!e.target.validity.valid) {
            e.target.setCustomValidity("O campo não pode ficar vazio");
         }
      };
...
$('#dtAvaliacao').datetimepicker({
   mask: '99/99/9999 29:59',
   lang: 'pt',
   format: 'd/m/Y H:i',
   formatDate: 'd/m/Y',
   step: 30
