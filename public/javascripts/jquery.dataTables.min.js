...
(function (Ea, P, k) {
   var O = function (h) {
         ...
         function tb(a) {
            ...
            for (g = 0; g < c; g++) m = b[g], l = f[g], i = "function" == typeof m.mData ? "function" : m.mData, k.columns.push({
               data: i,
               name: m.sName,
         ...
         function xb(a) {
            for (var b = o.ext.search, c = a.aiDisplay, e, d, f = 0, g = b.length; f < g; f++) {
         ...
         function Y(a) {
            ...
            if (r.outerWidth() < g) {
               ...
               if (w && (i.scrollHeight > i.offsetHeight || "scroll" == p.css("overflow-y"))) u.width = s(v - f);
         ...
         function Ga(a) {
            ...
            if (!p && !f && !d && j == aa(a) && j == i.length) for (n = 0; n < j; n++) c[n].sWidth = s(i.eq(n).width());
               ...
               for (n = 0; n < e.length; n++) k = c[e[n]], i[n].style.width = null !== k.sWidthOrig && "" !== k.sWidthOrig ? s(k.sWidthOrig) : "";
         ...
         function lb(a) {
            ...
            m = T(a);
            b = 0;
            for (c = m.length; b < c; b++) j = m[b], j.formatter && g++, Ib(a, j.col);
         ...
         o = function (a) {
            ...
            this.each(function () {
               ...
               if ("table" != this.nodeName.toLowerCase()) R(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                  ...
                  !0 === q.oScroll.sX && (q.oScroll.sX = "100%");
                  ...
                  ib(q, d.aoColumnDefs, r, function (a, b) {
                     ka(q, a, b)
                  });
                  if (s.length) {
                     var u = function (a, b) {
         ...
         o.isDataTable = o.fnIsDataTable = function (a) {
            var b = h(a).get(0),
               c = !1;
            h.each(o.settings, function (a, d) {
